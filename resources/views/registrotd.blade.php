...
@section('formulario')
    ...
    <form action="{{ route('registrar') }}" method="post">
        ...
        <div class="row">
            <div class="col-4">
                <button type="submit" class="btn btn-outline-warning btn-block w-100">Registrate por favor</button>
            </div>
            <!-- /.col -->
        </div>
    </form>
    <p class="mb-0">
        <a href="{{ route('login') }}" class="text-center">Iniciar sesion por favor</a>
    </p>
    <p class="mb-0">
