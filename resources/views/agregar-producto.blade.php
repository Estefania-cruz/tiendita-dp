...
@section('titulo')
    <title>Tiendita | Añadir productos nuevos</title>
@endsection
        ...
        <div class="row">
            <div class="card">
                <div class="card-header col-md-10 m-auto">
                    <h1 class="text-center">Añadir productos nuevos</h1>
                    @if (isset($estatus))
                        @if ($estatus == 'error')
                ...
                <div class="card-body col-md-10 m-auto navbar-blue">
                    <form action="{{ route('agregarProductoN') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @error('img1')
                                <small class="text-danger ">Solo  imagenes por favor</small>
                                @enderror
                                <div class="row">
                                    <div class="mb-3">
                        ...
                        <button class="btn btn-secondary btn-lg btn-block">Añadir nuevo producto</button>
                    </form>
                </div>
            </div>
        </div>
