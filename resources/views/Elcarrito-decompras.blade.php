        ...
        <div class="col-md-10 m-auto">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="row">
                        <button type="button" class="btn btn-success" id="comprar">Comprar para disfrutar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function eliminar() {
            ...
            $.ajax({
                ...
                url: "{{ route('deleteproductodemiCarrito') }}/" + id,
                type: 'POST',
                dataType: 'json',
            })
        ...
        $(document).ready(function() {
            $("#comprar").click(function(event) {
                $.ajax({
                    ...
                    url: "{{ route('realizarlasCompra') }}/" + {{ session('usuario')->id }},
                    type: 'POST',
                    dataType: 'json',
