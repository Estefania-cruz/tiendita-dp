            ...
            @if (isset($productos))
                                ...
                                <div id="{{ $producto->nombre }}" class="carousel slide" style="height: 12rem;" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ \Illuminate\Support\Facades\Storage::url($producto->foto1) }}" accept="image/*" class="d-block w-100" alt="imagen1">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ \Illuminate\Support\Facades\Storage::url($producto->foto2) }}" accept="image/*" class="d-block w-100" alt="imagen2">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                ...
                @else
                    <div class="col-12 alert alert-secondary">
                        <p>
                            Aun no hay productos para su demostracion sorry intente mas tarde
                        </p>
                    </div>
                @endif
            @endif
        ...
        function addCarrito(){
            ...
            if (cantidad == 0 || cantidad == '' || cantidad == null){
                ...
                $.ajax({
                    ...
                    error: function (){
                        alert("Inicia sesion  para realizar compras a tu carrito");
                    },
                });
            }
