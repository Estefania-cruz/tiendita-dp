...
@section('titulo')
    <title>Productos 7u7 | Administrador</title>
@endsection
    ...
    <div class="container">
        <div class="row">
                        ...
                        <table class="table" id="productos">
                            ...
                            @foreach ($productos as $producto)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-primary" onclick="editar({{ $producto->id }})"><i class="fas fa-pen"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="col-md-6 m-auto">
                <div class="card">
                    <div class="card-header">
                        <p id="nomProducto">Producto 7u7: </p>
                    </div>
                    <div class="card-body">
                        <form action="" method="POST" id="updateProducto">
                            ...
                            <button type="button" class="btn btn-outline-danger w-100" id="actualizar">Actualizar</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function editar(idproducto) {
            $.ajax({
                ...
                url: "{{ route('obtenerdatosobreProducto') }}/" + idproducto,
                type: 'POST',
                dataType: 'json',
            })
                .done(function(data) {
